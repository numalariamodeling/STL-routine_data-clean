...
# cases <- read.csv("~/Box/NU-malaria-team/projects/smc_impact/data/outputs/U5_DS_cases_seasonal_smc_good_rows_MA_imputes_testing_w_rep_weights_2.csv", header  = TRUE, strip.white = TRUE, stringsAsFactors = FALSE)
