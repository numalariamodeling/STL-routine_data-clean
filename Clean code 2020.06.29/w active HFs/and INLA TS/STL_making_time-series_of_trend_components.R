...
med_2014 <- read.csv("~/OneDrive/Desktop/medfever_DS_2014_INLA_fitted.csv", stringsAsFactors = FALSE)
med_2017 <- read.csv("~/OneDrive/Desktop/medfever_DS_2017_INLA_fitted.csv", stringsAsFactors = FALSE)
