...
write.csv(HF_cases_active, "~/Box/NU-malaria-team/projects/smc_impact/data/outputs/Ov5_HF_cases_smc_coords_imputed_rdts_and_allout_MA_activeHFs_2.csv", row.names = FALSE)
