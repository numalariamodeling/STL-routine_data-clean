...
View(cbind(STL_result_DF_slopes_new[,1], sign(STL_result_DF_slopes_new[,2:6])))

apply(cbind(STL_result_DF_slopes_new[,1], sign(STL_result_DF_slopes_new[,2:6]))[,2:6], 2, table)
