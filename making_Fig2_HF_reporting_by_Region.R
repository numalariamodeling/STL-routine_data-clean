...
bad_rows_missing_NOT_rdt_only <- bad_rows_missing[which(!(bad_rows_missing %in% bad_rows_missing_rdt_only))]
...
HF_cases_area[bad_rows_missing_NOT_rdt_only, "bad_rows"] <- "missing all-cause outpatient visits or missing both values"
...
HF_cases_area_by_Region$Type <- factor(HF_cases_area_by_Region$Type,
                                       levels = c("inconsistent report",
                                                  "missing all-cause outpatient visits or missing both values",
